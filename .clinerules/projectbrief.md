...
- **Tool Panel**: Provide a tool panel to customize the mind map's appearance, including node width, text direction, and line styles.
...
- You must keep all comments, do not remove any comments
- when you modify the code, you must write a comment to show what you have changed, with modify date.
